...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'customsbundle\\controller\\authcontroller' => 'CustomsBundle\\Controller\\AuthController',
            'customsbundle\\controller\\defaultcontroller' => 'CustomsBundle\\Controller\\DefaultController',
            'customsbundle\\form\\usertype' => 'CustomsBundle\\Form\\UserType',
        ...
        $this->fileMap = [
            ...
            'CustomsBundle\\Controller\\AuthController' => 'getAuthControllerService.php',
            'CustomsBundle\\Controller\\DefaultController' => 'getDefaultController2Service.php',
            'CustomsBundle\\Form\\UserType' => 'getUserTypeService.php',
            ...
            'security.user.provider.concrete.our_userdb_provider' => 'getSecurity_User_Provider_Concrete_OurUserdbProviderService.php',
        ...
        $this->privates = [
            ...
            'CustomsBundle\\Form\\UserType' => true,
            ...
            'security.user.provider.concrete.our_userdb_provider' => true,
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/AppBundle/Twig/Helper.php';
     ...
     *
     * @return \AppBundle\Twig\Helper
     */
    protected function getApp_TwigExtensionService()
    {
        return $this->services['app.twig_extension'] = new \AppBundle\Twig\Helper();
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OibRgVAyGb', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hJfpEfRlRo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\Helper());
        $instance->addExtension(${($_ = isset($this->services['app.twig_extension']) ? $this->services['app.twig_extension'] : ($this->services['app.twig_extension'] = new \AppBundle\Twig\Helper())) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ubIr0eFHk6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o+wnpxkLAh', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AB4U8uK4P+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CustomsBundle/Resources/views'), '!Customs');
        $instance->addPath(($this->targetDirs[3].'/src/CustomerBundle/Resources/views'), 'Customer');
        $instance->addPath(($this->targetDirs[3].'/src/CustomerBundle/Resources/views'), '!Customer');
        $instance->addPath(($this->targetDirs[3].'/src/NutritionistBundle/Resources/views'), 'Nutritionist');
        $instance->addPath(($this->targetDirs[3].'/src/NutritionistBundle/Resources/views'), '!Nutritionist');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings([0 => ($this->targetDirs[3].'/src/AppBundle/Resources/config/validation.yml'), 1 => ($this->targetDirs[3].'/src/CustomsBundle/Resources/config/validation.yml')]);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CustomerBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CustomerBundle'),
                    'namespace' => 'CustomerBundle',
                ],
                'NutritionistBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/NutritionistBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'CustomerBundle' => 'CustomerBundle\\CustomerBundle',
                'NutritionistBundle' => 'NutritionistBundle\\NutritionistBundle',
