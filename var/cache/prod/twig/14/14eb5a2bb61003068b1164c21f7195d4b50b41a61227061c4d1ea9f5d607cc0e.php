    ...
    <section id=\"customer-personal-data\">
        <div class=\"container\">
            ...
            <div class=\"col-sm-6\" style=\"display: inline-flex\">
                <div class=\"personal-data-fields\" style=\"margin-top: 15%\">
                    <label for=\"bibliografia\">Descripción / Bibliografía:</label><input type=\"text\" id=\"bibliografia\" name=\"_bibliografia\" class=\"form-control\"/>
                    <label for=\"objetivos\">Objetivos:</label><input type=\"text\" id=\"objetivos\" name=\"_objetivos\" class=\"form-control\"/>
                    ...
                    <label for=\"actividad\"></label><select id=\"actividad\" name=\"actividad\" class=\"form-select\">
