        ...
        echo "\" method=\"post\">
                        <div class=\"col-sm-6\">
                            <div class=\"personal-data-header\">
                                ...
                                <h3 style=\"display: inline-flex\">Añadir Cliente</h3>
                            </div>
                            <br/>
                            ...
                            <div class=\"personal-data-fields\">
                                <label for=\"firstname\">Nombre:</label><input type=\"text\" id=\"firstname\" name=\"firstname\" class=\"form-control\"/>
                                <label for=\"lastname\">Apellidos:</label><input type=\"text\" id=\"lastname\" name=\"lastname\" class=\"form-control\"/>
...
";
    ...
    <section id=\"nutritionist-add-customer\">
        ...
        <div class=\"container\">
            <div class=\"col-sm-12\">
                <div id=\"add-customer-block\">
                    <form class=\"form\" action=\"{{ path(\"nutritionist_add_customer\") }}\" method=\"post\">
                        <div class=\"col-sm-6\">
                            <div class=\"personal-data-header\">
                                <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-person-circle\" viewBox=\"0 0 16 16\">
                                    <path d=\"M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z\"/>
