...
$c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver([($this->targetDirs[3].'/src/CustomsBundle/Resources/config/doctrine') => 'CustomsBundle\\Entity', ($this->targetDirs[3].'/src/NutritionistBundle/Resources/config/doctrine') => 'NutritionistBundle\\Entity']);
$c->setGlobalBasename('mapping');

$b->addDriver($c, 'CustomsBundle\\Entity');
$b->addDriver($c, 'NutritionistBundle\\Entity');

$a->setEntityNamespaces(['CustomsBundle' => 'CustomsBundle\\Entity', 'NutritionistBundle' => 'NutritionistBundle\\Entity']);
